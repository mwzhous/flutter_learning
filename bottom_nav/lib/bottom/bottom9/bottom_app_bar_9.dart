...
class BottomBar9 extends StatefulWidget {
  ...
  @override
  BottomBar9State createState() => BottomBar9State();
}

class BottomBar9State extends State<BottomBar9> with TickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xff18a4b6).withOpacity(0.8),
                            width: 1.8),
                      ),
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: borderRadius,
                        border: Border.all(
                            color: const Color(0xffc82440).withOpacity(0.8),
                            width: 1.8),
                      ),
                    ),
