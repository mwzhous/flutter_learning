...
class BottomBar3 extends StatefulWidget {
  ...
  @override
  BottomBar3State createState() => BottomBar3State();
}

class BottomBar3State extends State<BottomBar3> with TickerProviderStateMixin {
  /// 刚进来加载时候缩放动画
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(iconData, size: 28, color: const Color(0xff2b292b)),
            const SizedBox(height: 4),
            Text(title,
                style: const TextStyle(fontSize: 12, color: Color(0xff2b292b)))
          ],
        ),
      ),
    );
