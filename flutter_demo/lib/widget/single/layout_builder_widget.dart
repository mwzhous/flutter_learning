...
class _LayoutBuilderWidgetState extends State<LayoutBuilderWidget> {
          ...
          child:Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  '可以检测到父容器的区域大小，并根据父容器的尺寸信息完成定义布局，是一个非常使用的组件。',
                  style: descStyle,
                ),
              ),
              const Text(
              ...
              const Text( 'Layout适应布局', style: titleStyle,
              ),
              Container(
                margin: const EdgeInsets.symmetric(
                  vertical: 10.0,
                ...
                child: const Text(
                  '可以根据组件区域的大小进行组件的展示设计，比如在不同宽度的区域显示不同布局的组件。',
                  style: descStyle,
                ),
              ),
              Column(
  ...
  Widget _buildSlider() {
    return Slider(
      min: 50,
      max: 300,
      label: "父宽:${_width.toStringAsFixed(1)}", value: _width,
