          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  'AnimatedWidget的子类，使用 Alignment 类型的动画器让子组件在 Alignment 对象之间进行过渡画面。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
              ...
              Container(
                ...
                child: const Text(
                  'AnimatedWidget的子类，使用 Offset 类型的动画器让子组件在 Offset 对象之间进行过渡动画。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
              ...
              Container(
                ...
                child: const Text(
                  'AnimatedWidget的子类，使用 Decorated 类型的动画器让子组件在 Decorated 对象之间进行过渡动画。',
                  style: descStyle,
                ),
              ),
              GestureDetector(
